# Release notes & publish sheets

Operator documents for each MiniBook3 ship. **Not** read by in-app auto-update.
...
Use the notes file as the **GitHub Release body** when creating tag `vX.Y.Z`.

Warehouse map: [`../../README.md`](../../README.md) · frozen paths: [`../layout.md`](../layout.md).
